...
const MONITOR_ACCOUNTS = [
  {
    nickname: '徐老师AI',
    url: 'https://v.douyin.com/i5xRQGV8/',
    tags: ['AI', '科技'],
  },
  {
    nickname: '卡兹克',
    url: 'https://v.douyin.com/i5xRQGV8/',  // 需要实际链接
    tags: ['AI', 'AIGC', '科技'],
  },
  {
    nickname: '秋芝2046',
...
// 获取用户主页视频
async function getUserVideos(shareUrl, page = 1) {
  try {
...
async function main() {
  ...
  for (const account of MONITOR_ACCOUNTS) {
    ...
    const videos = await getUserVideos(account.url);
